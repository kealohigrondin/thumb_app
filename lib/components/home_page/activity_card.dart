        ...
        children: [
          ...
          ride.description!.isNotEmpty
              ? Padding(
                  ...
                  child: Text(ride.description!, textAlign: TextAlign.start, maxLines: 2, style: Theme.of(context).textTheme.labelMedium),
                )
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Row(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.end, children: [
                  UserIconButton(
                      imagePath:
